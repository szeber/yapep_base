...
class AutoloaderContainer {
    ...
    /**
     *
     * @var \YapepBase\Autoloader\AutoloaderContainer
     */
    protected static $instance;

    /**
     * Singleton instance getter.
     * @return \YapepBase\Autoloader\AutoloaderContainer
     */
     ...
     */
    public function detachByClass($autoloaderClass, $autounregister = null) {
        foreach ($this->registry as $autoloader) {
