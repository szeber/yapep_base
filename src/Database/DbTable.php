...
abstract class DbTable
{
     ...
     */
    abstract protected function buildInsertQuery(array $data, array &$params, array $updateData = []);
     ...
     */
    public function insert(array $insertData, array $updateData = [], &$lastInsertId = false)
    {
    ...
    {
        if (!in_array($direction, [self::ORDER_ASC, self::ORDER_DESC, null])) {
