...
class UrlHelper extends HelperAbstract
{
     ...
     */
    public function getRouteTarget($controller, $action, array $params = [], array $getParams = [])
    {
        try {
    ...
    public function checkIsCurrentControllerAction($controller, $action)
    {
        ...
        $currentAction     = null;
        Application::getInstance()->populateDispatchedAction($currentController, $currentAction);
