...
/**
 * Simple floating console debugger renderer
 *
 * @package    YapepBase
 * @subpackage Debugger
 */
class ConsoleDebuggerRenderer implements IDebuggerRenderer {
	...
	public function render(
		$startTime, $runTime, $currentMemory, $peakMemory, array $times, array $memoryUsages,
		...
		$template = new ConsoleDebuggerTemplate($viewDo, 'runTime', 'peakMemory', 'times', 'memoryUsages', 'info',
			'errors', 'queries', 'queryTimes', 'counters');
