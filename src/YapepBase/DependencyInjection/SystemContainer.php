...
class SystemContainer extends Container
{
    ...
    protected $searchNamespaces = [
        self::NAMESPACE_SEARCH_TEMPLATE => [],
        self::NAMESPACE_SEARCH_CONTROLLER => [],
        self::NAMESPACE_SEARCH_BO => [],
        self::NAMESPACE_SEARCH_DAO => [],
        self::NAMESPACE_SEARCH_VALIDATOR => [],
    ];
    ...
    public function __construct()
    {
        ...
        $this->searchNamespaces[self::NAMESPACE_SEARCH_BO]        = [];
        $this->searchNamespaces[self::NAMESPACE_SEARCH_DAO]       = [];
        $this->searchNamespaces[self::NAMESPACE_SEARCH_VALIDATOR] = [];
    }
     ...
     * @return void
     */
    public function setSearchNamespaces($type, array $namespaces = [])
    {
    ...
    public function setDebugger(IDebugger $debugger)
    {
        ...
        if ($debugger instanceof IEventHandler) {
            $this->getEventHandlerRegistry()
                 ->registerEventHandler(Event::TYPE_APPLICATION_BEFORE_OUTPUT_SEND,
                     $debugger);
        }
    }
