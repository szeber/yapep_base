 ...
 */
class ApplicationTest extends \YapepBase\BaseTest {

	/**
	 * @var \YapepBase\Mock\ApplicationMock
	 */
	protected $object;
	protected $oldApp;
	...
	public function testSetRouter() {
		$router = new \YapepBase\Mock\Router\RouterMock();
	...
	public function testGetI18nTranslator() {
		...
		$translator = new \YapepBase\Mock\I18n\TranslatorMock();
	...
	public function testRun() {
		...
		$this->object->getDiContainer()->setSearchNamespaces(SystemContainer::NAMESPACE_SEARCH_CONTROLLER,
			array('\YapepBase\Mock\Controller'));
		$this->object->setRequest($request);
		$this->object->setResponse($response);
		$this->object->setRouter($router);
		$this->object->run();
