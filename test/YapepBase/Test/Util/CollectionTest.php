...
class CollectionTest extends \PHPUnit_Framework_TestCase {
	public function testConstructor() {
		...
		$elements[] = $o1;
		$elements[] = $o2;
		$collection = new \YapepBase\Test\Mock\Util\CollectionMock($elements);
		$this->assertEquals($o1, $collection[0]);
		$this->assertEquals($o2, $collection[1]);

		$o3 = new \YapepBase\Test\Mock\Util\CollectionElementMock();
		$collection = new \YapepBase\Test\Mock\Util\CollectionMock($o3);
	...
	public function testExtendedApi() {
		$collection1 = new \YapepBase\Test\Mock\Util\CollectionMock();
		$o1 = new \YapepBase\Test\Mock\Util\CollectionElementMock();
		$o2 = new \YapepBase\Test\Mock\Util\CollectionElementMock();
		$o3 = new \YapepBase\Test\Mock\Util\CollectionElementMock();
		$collection1->add($o1);
		...
		$collection1->add($o1);
		$collection1->add($o2);
		$collection2 = new \YapepBase\Test\Mock\Util\CollectionMock();
		...
		$collection2->add($o1);
		$collection2->add($o2);
		$collection3 = new \YapepBase\Test\Mock\Util\CollectionMock();
		$collection3->add($o3);
