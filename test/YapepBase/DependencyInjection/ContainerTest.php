...
use YapepBase\Mock\DependencyInjection\ObjectMock;
...
class ContainerTest extends \YapepBase\BaseTest {
	...
	public function testSetWithClosure() {
		...
		$this->assertInstanceOf('YapepBase\Mock\DependencyInjection\ObjectMock', $container['test']);
	}
	...
	public function testStoredObjectsDifference() {
		...
		$this->assertInstanceOf('YapepBase\Mock\DependencyInjection\ObjectMock', $objectOne);

		$objectTwo = $container['test'];
		$this->assertInstanceOf('YapepBase\Mock\DependencyInjection\ObjectMock', $objectTwo);
