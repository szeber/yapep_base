...
class SimpleAutoloaderTest extends \PHPUnit_Framework_TestCase {
	...
	public function testLoad() {
		...
		$this->assertTrue($this->object->load('\\YapepBase\\Mock\\Autoloader\\ClassMock'));
		$this->assertTrue($this->object->load('\\YapepBase\\Mock\\Autoloader\\InterfaceMock'));
		try {
			$this->assertFalse($this->object->load('\\YapepBase\\Mock\\Autoloader\\NonexistentClassMock'));
		} catch (\PHPUnit_Framework_Error_Warning $e) {}
		try {
			$this->assertFalse($this->object->load('\\YapepBase\\Mock\\Autoloader\\EmptyMock'));
		} catch (\PHPUnit_Framework_Error_Warning $e) {}
	}
